        ...
        extends AbstractTestBlock
{
    ...
    public void testSingleValueBlock()
    {
        ...
        // ArrayBlock holds onto the offsets from builder. Offsets can contain additional elements.
        // MapBlock copies the required portion of the offsets into a new array.
        // To create Array block with offsets length of 2, set the initial size of builder to 1.
        BlockBuilder arrayBlockBuilder = new ArrayBlockBuilder(BIGINT, null, 1, 100);
