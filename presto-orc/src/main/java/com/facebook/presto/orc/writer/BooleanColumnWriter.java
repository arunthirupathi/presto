        ...
        implements ColumnWriter
{
            ...
            throws IOException
    {
        ...
        for (int i = 0; i < rowGroupColumnStatistics.size(); i++) {
            ...
            List<Long> positions = createBooleanColumnPositionList(compressed, dataCheckpoint, presentCheckpoint);
    ...
    private static List<Long> createBooleanColumnPositionList(
            boolean compressed,
